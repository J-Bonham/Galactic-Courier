...
-(void)didMoveToView:(SKView *)view {
    ...
    _lvl2 = NO;
        [self playMusic:@"bgm.mp3"];
    
    NSData *localLBData = [[NSUserDefaults standardUserDefaults] objectForKey:@"lb"];
    ...
    //Create Backgrounds
    bg1 = [SKSpriteNode spriteNodeWithImageNamed:@"bg020.png"];
    bg1.anchorPoint = CGPointZero;
    bg1.position = CGPointMake(0, 0);
    bg1.zPosition = 0;
    [self addChild:bg1];
    
    bg2 = [SKSpriteNode spriteNodeWithImageNamed:@"bg010.png"];
    ...
    shieldPowerUp = [SKSpriteNode spriteNodeWithImageNamed:@"ShieldPowerUp.png"];
    ...
    shield = [SKSpriteNode spriteNodeWithImageNamed:@"Shield.png"];
    shield.alpha = 0;
    ...
    //Level End
    finishLine = [SKSpriteNode spriteNodeWithImageNamed:@"finish.png"];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex == 0) {
        ...
        [[NSUserDefaults standardUserDefaults] setObject:lbData forKey:@"lb"];
...
//            [nameAlert show];
            ...
            [[NSUserDefaults standardUserDefaults] setInteger:_scoreValue forKey:@"lb"];
            [[NSUserDefaults standardUserDefaults] synchronize];
...
- (void) reportHighScore:(NSInteger) highScore {
    if ([GKLocalPlayer localPlayer].isAuthenticated) {
        GKScore* score = [[GKScore alloc] initWithLeaderboardIdentifier:@"lb"];
