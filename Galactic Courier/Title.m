...
-(void)didMoveToView:(SKView *)view {
    ...
    bg1 = [SKSpriteNode spriteNodeWithImageNamed:@"bg010.png"];
...
//    [self addChild:localLB];
    ...
    instructions.position = CGPointMake(CGRectGetMidX(self.frame), CGRectGetMidY(self.frame) - 150);
    ...
    credits.fontSize = 40;
    credits.position = CGPointMake(CGRectGetMidX(self.frame), CGRectGetMidY(self.frame) - 225);
    credits.zPosition = 1;
